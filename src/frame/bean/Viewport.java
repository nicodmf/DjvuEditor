  ...
  implements AdjustmentListener
{
   ...
   */
  public JScrollBar getScrollbar(int orientation)
  {
    return (orientation == JScrollBar.HORIZONTAL)
    ? hScroll
    : vScroll;
  }
...
//bcr      getImageWait().setBufferMode(DjVuImage.COMPLETE_BUFFER);
      setScrollbar(
        ...
        new JScrollBar(Scrollbar.HORIZONTAL));
      setScrollbar(
        Scrollbar.VERTICAL,
  ...
  public void adjustmentValueChanged(AdjustmentEvent event)
  {
    try
    {
      final JScrollBar hScroll        = getScrollbar(JScrollBar.HORIZONTAL);
      final JScrollBar vScroll        = getScrollbar(JScrollBar.VERTICAL);
